...
namespace NDRExpressionEvaluator.CodeAnalysis.Binder
{
    ...
    internal sealed class Binder
    {
        ...
        private BoundExpression BindUnaryExpression(UnaryExpressionSyntax syntax)
        {
            ...
            {
                _diagnostics.Add($"Unary operator '{syntax.OperatorToken.Text}' is not defind for type {boundOperand.Type}.");
                return boundOperand;
            }
        ...
        private BoundExpression BindBinaryExpression(BinaryExpressionSyntax syntax)
        {
            ...
            // Make sure nothing null references.
            if (boundOperatorKind == null)
            {
                _diagnostics.Add($"Binary operator '{syntax.OperatorToken.Text}' is not defind for type {boundLeft.Type} and {boundRight}.");
                return boundLeft;
            }

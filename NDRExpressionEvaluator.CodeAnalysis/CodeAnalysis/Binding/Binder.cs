...
namespace NDRExpressionEvaluator.CodeAnalysis.Binding
{
    ...
    internal sealed class Binder
    {
        ...
        {
            // if it's value is NULL then make it 0
        ...
        private BoundExpression BindUnaryExpression(UnaryExpressionSyntax syntax)
        {
            ...
            {
                diagnostics.Add($"Unary operator '{syntax.OperatorToken.Text}' is not defind for type {boundOperand.Type}");
                return boundOperand;
            }
        ...
        private BoundExpression BindBinaryExpression(BinaryExpressionSyntax syntax)
        {
            ...
            if (boundOperatorKind == null)
            {
                diagnostics.Add($"Binary operator '{syntax.OperatorToken.Text}' is not defind for type {boundLeft.Type} and {boundRight.Type}");
                return boundLeft;
            }
